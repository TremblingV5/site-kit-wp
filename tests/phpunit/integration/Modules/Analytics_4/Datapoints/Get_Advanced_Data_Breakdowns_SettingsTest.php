...
class Get_Advanced_Data_Breakdowns_SettingsTest extends TestCase {
	...
	public function test_create_request__returns_dedicated_option_for_admin() {
	...
	public function test_create_request__returns_view_only_keys_for_non_admin() {
	...
	public function test_parse_response_returns_unchanged() {
		$data_request = new Data_Request( 'GET', 'modules', 'analytics-4', 'advanced-data-breakdowns-settings', array() );
