...
class Advanced_Data_Breakdowns_SettingsTest extends SettingsTestCase {
	...
	public function test_sanitize_keeps_existing_value_when_input_is_not_array() {
		$this->settings->register();
	...
	public function test_is_enabled_returns_stored_state() {
		$this->settings->register();
	...
	public function test_merge_partial_update() {
		$this->settings->register();
		...
		$flipped = $this->settings->merge( array( 'enabled' => false ) );
